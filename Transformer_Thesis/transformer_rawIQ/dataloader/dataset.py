...
This module defines:
1.  SingleStreamImageDataset: A Dataset class for loading I/Q signal data as raw sequences.
...
class SingleStreamImageDataset(Dataset):
    ...
    Returns raw I/Q data in shape [2, sequence_length] instead of 2D images.
    """
    ...
    def __getitem__(self, idx: int) -> Tuple[torch.Tensor, int, float]:
        ...
        Returns:
            iq_data: Tensor of shape [2, sequence_length] where first channel is I, second is Q
            y_label: Integer label for the modulation class
            z_snr: SNR value as float
        """
        ...
        # Transpose to [2, sequence_length] format
        # Original shape: [sequence_length, 2] where dim 0=I, dim 1=Q
        # New shape: [2, sequence_length] where channel 0=I, channel 1=Q
        iq_data = iq_sequence.transpose(0, 1)

        return iq_data, y_label, z_snr
